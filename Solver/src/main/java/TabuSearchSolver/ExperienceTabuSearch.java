...
public class ExperienceTabuSearch implements IObjectiveFunction {


    private static final String OBJECTIVE_TITLE = "Mean Absolute Deviation of the objectivefunction.TabuSearch.Experience Level";//
