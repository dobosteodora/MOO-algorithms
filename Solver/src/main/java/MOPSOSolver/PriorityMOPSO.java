...
public class PriorityMOPSO implements IObjectiveFunction {

    private static final String OBJECTIVE_TITLE = "Mean Priority";
    ...
    public double getObjectiveValue(int[] fitness) {
        ...
        //Option 1: this is the objective as defined in Dora's thesis
